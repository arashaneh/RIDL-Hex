...
orig = cv2.imread('image_0002.jpg')
#orig = cv2.imread('cameraman.png')
#orig = cv2.imread('colorbar.png')
...
#xy_c = [95, 280]
#print window_scale
#sample = block_mean(orig, xy_c, base_size, int(window_scale[0]))
#print sample.shape

sample_M = Sample_retina(orig, fovea_xy, base_size, n_t, M_f, M_p)


#TODO: Implement all resampling and filtering in GPU

#TODO: Loop over point/scale   

#block_mean(img, xy_c, base_size, scale)

#TODO: Build a dataset of all windows and rotated ones into a large matrix

#TODO: Learn an sparse representation of the matrix (Sparse dictionary)

#TODO: Define a neighborhood in retina-like representation of the features
...
#plt.scatter(xy_photoreceptor[:,0],
#            xy_photoreceptor[:,1],c=u'w')     


#xy_neighbors = find_neighbor(tc_center[0], tc_center[1], M_f, M_p, n_t)
#plt.scatter(xy_photoreceptor[xy_neighbors,0],+
#            xy_photoreceptor[xy_neighbors,1], c=np.arange(6),s=40) #c=u'b')#
#plt.colorbar()            
#plt.scatter(photoreceptor_coord[tc_center[0],tc_center[1],0],photoreceptor_coord[tc_center[0],tc_center[1],1],c=u'g',s=40)   
#
#plt.show()
